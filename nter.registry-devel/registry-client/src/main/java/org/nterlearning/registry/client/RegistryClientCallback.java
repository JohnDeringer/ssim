 ...
 *         Date: 4/27/12
 */
public class RegistryClientCallback implements CallbackHandler {

    private String username;
    private String password;

    private Logger logger = LoggerFactory.getLogger(RegistryClientCallback.class);

    public RegistryClientCallback(String username, String password) {
