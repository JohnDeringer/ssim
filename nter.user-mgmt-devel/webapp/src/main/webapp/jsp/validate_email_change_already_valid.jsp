...
<head>
    ...
    <title><spring:message code="title.validate.email.change"/></title>
...
<div id="main">
		<h1><spring:message code="email.change.verified.title"/></h1>
		<p><spring:message code="email.change.verified.already"/></p>
